...
figure
imshow( uint8(I1) );  hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
...
figure
imshow( uint8(I2) );  hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
...
figure
imshow( uint8(I3) );  hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
...
figure; imshow( ROI_I3 ); title('I3 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I3_croped.emf'));
 ...
 figure
imshow( uint8(I4) );  hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
...
figure
imshow( uint8(I5) );  hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
...
figure
imshow( uint8(I6) );  hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
