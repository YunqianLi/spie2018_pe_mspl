...
figure
imshow( uint8(I1) ); title('Regions of Interest'); hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
saveas(gcf,strcat( ImagesOutputPath, 'I1_croped_range.emf'));
ROI_I1 = imcrop( I1, [ROI_start(1), ROI_start(2), (ROI_end(1) - ROI_start(1) + 1), (ROI_end(2) - ROI_start(2) + 1)] );
figure; imshow( ROI_I1 ); title('I1 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I1_croped.emf'));

figure
imshow( uint8(I2) ); title('Regions of Interest'); hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
saveas(gcf,strcat( ImagesOutputPath, 'I2_croped_range.emf'));
ROI_I2 = imcrop( I2, [ROI_start(1), ROI_start(2), (ROI_end(1) - ROI_start(1) + 1), (ROI_end(2) - ROI_start(2) + 1)] );
figure; imshow( ROI_I2 ); title('I2 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I2_croped.emf'));


figure
imshow( uint8(I3) ); title('Regions of Interest'); hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
saveas(gcf,strcat( ImagesOutputPath, 'I3_croped_range.emf'));
ROI_I3 = imcrop( I3, [ROI_start(1), ROI_start(2), (ROI_end(1) - ROI_start(1) + 1), (ROI_end(2) - ROI_start(2) + 1)] );
figure; imshow( ROI_I3 ); title('I3 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I3_croped.emf'));



 figure
imshow( uint8(I4) ); title('Regions of Interest'); hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
saveas(gcf,strcat( ImagesOutputPath, 'I4_croped_range.emf'));
ROI_I4 = imcrop( I4, [ROI_start(1), ROI_start(2), (ROI_end(1) - ROI_start(1) + 1), (ROI_end(2) - ROI_start(2) + 1)] );
figure; imshow( ROI_I4 ); title('I4 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I4_croped.emf'));

figure
imshow( uint8(I5) ); title('Regions of Interest'); hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
saveas(gcf,strcat( ImagesOutputPath, 'I5_croped_range.emf'));
ROI_I5 = imcrop( I5, [ROI_start(1), ROI_start(2), (ROI_end(1) - ROI_start(1) + 1), (ROI_end(2) - ROI_start(2) + 1)] );
figure; imshow( ROI_I5 ); title('I5 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I5_croped.emf'));

figure
imshow( uint8(I6) ); title('Regions of Interest'); hold on; rectangle('Position',[ROI_start, ROI_end - ROI_start],'EdgeColor','y', 'LineWidth', 4); hold off
saveas(gcf,strcat( ImagesOutputPath, 'I6_croped_range.emf'));
ROI_I6 = imcrop( I6, [ROI_start(1), ROI_start(2), (ROI_end(1) - ROI_start(1) + 1), (ROI_end(2) - ROI_start(2) + 1)] );
figure; imshow( ROI_I6 ); title('I6 croped'); saveas(gcf,strcat( ImagesOutputPath, 'I6_croped.emf'));
...
figure
imshow( I3 ); title('Image_LinearPolarAzimuthVector(corrected)'); hold on; 
quiver( dis_x, dis_y, Dop_x_rect( dis_y_line, dis_x_line  ), -Dop_y_rect( dis_y_line, dis_x_line), 'g' );
saveas(gcf,strcat( ImagesOutputPath, 'Image_LinearPolarAzimuthVector_compare.emf'));
